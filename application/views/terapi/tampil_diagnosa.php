...
if(empty($query)){
	...
	foreach($query as $row):
		...
		<tr>
			...
			<td>
				<a href="#" onclick="hapusdiagnosa('<?php echo $row->no_reg;?>','<?php echo $row->pasien_id;?>','<?php echo $row->diagnosa ?>','<?php echo $row->tanggal_periksa ?>')" title="Hapus Data Diagnosa" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
			</td>
		</tr>
		<?php
	endforeach;
