...
<body onload="window.print()">
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="3" align="center">
    <tr>
      <th colspan="2" align="left">Data Keluhan</th>
    </tr>
    <tr>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="3" align="center">
    <tr>
      <th colspan="2" align="left">Data Diagnosa</th>
    </tr>
    <tr>
      <td style="border-top:1px solid #000;border-bottom:1px solid #000;">No.</td>
      <td style="border-top:1px solid #000;border-bottom:1px solid #000;">Tanggal</td>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="3" align="center">
    <tr>
      <th colspan="2" align="left">Data Tindakan</th>
    </tr>
    <tr>
      <td style="border-top:1px solid #000;border-bottom:1px solid #000;">No.</td>
      <td style="border-top:1px solid #000;border-bottom:1px solid #000;">Tanggal</td>
  ...
  <table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <th colspan="4" align="left">Data Resep</th>
    </tr>
    <tr>
      <td width="13">
        <div align="center" class="style14" style="border-top:1px solid #000;border-bottom:1px solid #000;"></div>
      </td>
    ...
    <tr>
      <td>
        <div align="left" class="style14">Resep dokter dapat dicetak manual</div>
      </td>
      <!-- <td><div align="center" class="style14"><?php #echo $no;
                                                    ?></div></td>
    <td><div align="center" class="style14"><?php #echo $rowterapi->terapi;
                                            ?></div></td>
    <td><div align="center" class="style14"><?php #echo $rowterapi->etiket;
                                            ?></div></td>
    <td><div align="center" class="style14"><?php #echo $rowterapi->jml;
                                            ?></div></td> -->
    </tr>
    <!--  <?php
          // }
