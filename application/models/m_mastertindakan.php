	...
	public function get_items()
	{
		...
		foreach ($query->result() as $r) {
			$data[] = array(
				...
				<a href="' . site_url() . '/master_tindakan/hapus/' . $r->tindakan_id . '" class="btn btn-sm btn-danger" title="Hapus Data" onclick="return confirm(\'Yakin mau hapus data ini?\')"><i class="glyphicon glyphicon-trash"></i></a>',
			);
		}
